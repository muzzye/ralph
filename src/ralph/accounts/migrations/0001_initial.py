    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_id', models.CharField(verbose_name='employee id', max_length=64, blank=True)),
                ('profit_center', models.CharField(verbose_name='profit center', max_length=1024, blank=True)),
                ('cost_center', models.CharField(verbose_name='cost center', max_length=1024, blank=True)),
                ('department', models.CharField(verbose_name='department', max_length=64, blank=True)),
                ('manager', models.CharField(verbose_name='manager', max_length=1024, blank=True)),
                ('location', models.CharField(verbose_name='location', max_length=128, blank=True)),
                ('segment', models.CharField(verbose_name='segment', max_length=256, blank=True)),
            ...
            bases=(models.Model, ralph.lib.mixins.models.AdminAbsoluteUrlMixin, ralph.admin.autocomplete.AutocompleteTooltipMixin),
            managers=[
        ...
        migrations.AddField(
            ...
            name='regions',
            field=models.ManyToManyField(blank=True, related_name='users', to='accounts.Region'),
        ),
        migrations.AddField(
            model_name='ralphuser',
            name='team',
            field=models.ForeignKey(blank=True, null=True, to='accounts.Team'),
        ),
        migrations.AddField(
            model_name='ralphuser',
